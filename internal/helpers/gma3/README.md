...
1. Set **Preferred IP** / choose the **Interface** facing the showbridge machine.
2. An OSC row needs:
...
**Feedback direction (planned):** an OSC row with *Send* back to showbridge
