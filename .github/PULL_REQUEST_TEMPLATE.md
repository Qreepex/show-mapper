...
<!--
One connector / one profile / one fix per PR. Link the issue if any.
Hardware profiles: state how you verified the mapping (see CONTRIBUTING.md).
-->

## Checklist

- [ ] `make check` passes locally (vet, tests, svelte-check, builds)
